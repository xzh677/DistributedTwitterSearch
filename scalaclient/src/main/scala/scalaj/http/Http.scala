...
import java.net.{HttpURLConnection, InetSocketAddress, Proxy, URL, URLDecoder, URLEncoder}
import java.security.cert.X509Certificate
import java.util.zip.{GZIPInputStream, InflaterInputStream}
import javax.net.ssl._

import me.xinzhang.scala.twittersearch._
...
object HttpConstants {
  ...
  def base64(bytes: Array[Byte]): String = javax.xml.bind.DatatypeConverter.printBase64Binary(bytes)
